...
for threshold in np.arange(0.01, 0.11, 0.01):
    ...
    correlation_threshold = threshold  # You can adjust this threshold based on your needs
    ...
    output_file = r'C:\Users\prabh\Desktop\BCIs\Datasets\Schizophrenia\files\responder_erp_features_final{}.csv'.format(str(threshold))
